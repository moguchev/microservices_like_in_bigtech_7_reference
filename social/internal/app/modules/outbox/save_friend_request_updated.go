...
func (p *Processor) SaveFriendRequestUpdated(ctx context.Context, toUserID types.UserID, req *models.FriendRequest) error {
	const api = "outbox.Processor.SaveFriendRequestUpdated"
