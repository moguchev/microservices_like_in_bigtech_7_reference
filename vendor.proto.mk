...
.vendor-protovalidate:
	...
	git sparse-checkout set --no-cone proto/protovalidate/buf && \
	git checkout
...
.vendor-tidy:
	...
	find $(VENDOR_PROTO_PATH) -type f \( -name "internal_options.proto" -o -name "late_loaded_option.proto" -o -name "late_loaded_option_user.proto" \) -delete
